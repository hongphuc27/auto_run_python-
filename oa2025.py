...
# =========================
# FILTER: KÉO DỮ LIỆU TỪ 01/01/2025 ĐẾN 31/12/2025
# KHÔNG XÓA DỮ LIỆU TRONG BIGQUERY
# =========================
...
df = df[
    (df["Thoi_diem_tao_don"].dt.date >= start_date) &
    (df["Thoi_diem_tao_don"].dt.date <= end_date)
]

print(f"Reloading {len(df)} rows from {start_date} to {end_date}")
