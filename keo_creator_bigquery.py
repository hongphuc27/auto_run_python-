...
def run():
    ...
    start_date = (now_vn - timedelta(days=32)).replace(tzinfo=None)
    ...
    WHERE DATE(create_time) >= DATE_SUB(CURRENT_DATE("Asia/Ho_Chi_Minh"), INTERVAL 32 DAY)
    """
