...
START_TIME = (datetime.today() - timedelta(days=30)).strftime("%Y-%m-%d")
...
if __name__ == "__main__":
    ...
    delete_last_n_days(bq_client, days=30)
    print("✅ Delete done")
