#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Đồng bộ Lark Base Booking Live sang Google Sheets trên GitHub Actions."""
...
GG_SHEET_ID = os.getenv(
    "GG_SHEET_ID",
    "1BFGFvbZAegY6YNQd2JgbMfh9h6FULcix17XAEabFioI",
)
GG_SHEET_NAME = os.getenv("GG_SHEET_NAME", "fact_booking_live")
...
def main() -> None:
    ...
    print("Kéo dữ liệu Booking Live từ Lark Base...", flush=True)
